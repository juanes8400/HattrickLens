...
PUNTOS_POR_SEMANA: dict[int, float] = {
    17: 10.00, 18: 9.92, 19: 9.81, 20: 9.69, 21: 9.54, 22: 9.39, 23: 9.22,
    24: 9.04, 25: 8.85, 26: 8.66, 27: 8.47, 28: 8.27, 29: 8.07, 30: 7.87,
    31: 7.67, 32: 7.47, 33: 7.27, 34: 7.07, 35: 6.87, 36: 6.67, 37: 6.47,
    38: 6.26, 39: 6.06, 40: 5.86, 41: 5.65, 42: 6.45, 43: 6.24, 44: 6.04,
    45: 5.83,
}
...
def potential(ability_actual: int, age_years: int, age_days: int) -> int:
    ...
    if edad < EDAD_OBJETIVO:
        ...
        anos_enteros = sum(
            16 * _semana(k) for k in range(edad + 1, EDAD_OBJETIVO)
        )
