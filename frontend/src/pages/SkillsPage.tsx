...
export function SkillsPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* El interruptor parte la pantalla ENTERA (2026-09-20, pedido del
          usuario). «Profundidad» es todo lo que esta pantalla sabe de los
          puestos --las cifras de cabecera, el mapa, el recambio de cada
          puesto y el cuello de botella-- y «Mejor posición» es la misma
          plantilla vista desde la cancha. Son dos lecturas completas, no dos
          bloques sueltos, así que se eligen antes de nada y no a media
          pantalla. */}
      <Tabs
        ...
        {vistaDePuestos === "mejor" ? (
            ...
            >
              <div className="px-4 pt-3">
                <Tabs
                  modo="filtro"
                  label={t(
                    "habilidades.queJugadores",
                    "Qué jugadores se miran",
                  )}
                  tabs={[
                    ...(hayOnce
                      ? [
          ...
          quien entraría de verdad. Ordenados por rendimiento en el puesto. */}
            <Panel
              ...
              meta={t(
                "habilidades.sinContarLesionados",
                "sin contar lesionados",
              )}
            >
                    ...
                    <label className="flex items-center gap-2 text-xs text-[var(--muted)]">
                      ...
                      <select
                        ...
                        onChange={(e) => {
                          ...
                          setFormacion(
                            elegida === data.formation ? "" : elegida,
                          );
              ...
              {data.sectors.length === 0 ? (
                ...
                <div className="space-y-5 px-4 py-4">
                  ...
                  <div className="grid gap-4 md:grid-cols-3">
                    {data.sectors.map((s) => {
                      const tope =
                        Math.max(s.rating, s.bestRivalValue ?? 0) || 1;
                      return (
                        <div
                          key={s.key}
