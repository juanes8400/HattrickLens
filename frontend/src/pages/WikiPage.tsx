...
const ARTICULOS: Articulo[] = [
  // ── Empezar ──────────────────────────────────────────────────────────────
  {
    ...
    secciones: [
      ...
      {
        titulo: "Tres principios que se repiten en toda la app",
        puntos: [
  ...
  },
  {
    ...
    secciones: [
      ...
      {
        titulo: "La primera sincronización",
        texto: [
      ...
      {
        titulo: "Por qué conviene sincronizar a menudo",
        texto: [
  ...
  },
  {
    ...
    secciones: [
      ...
      {
        titulo: "Colores y estados",
        puntos: [
          "Verde: bueno, cubierto o por encima de lo esperado.",
          "Ámbar: cuidado, algo que vigilar.",
          "Rojo: un problema o un peligro.",
          "Azul: el color de acento, para selecciones y enlaces.",
    ...
    secciones: [
      ...
      },
      {
        ...
        puntos: [
          ...
          "Alertas que requieren tu atención, con opción de archivarlas.",
          "Mejor once, con el selector de formación, Defensas Centrales y Mediocentros.",
          "La flor de fuerza frente a la serie.",
        ],
      },
      {
        titulo: "La flor de fuerza",
        texto: [
    ...
    secciones: [
      {
        ...
        puntos: [
          ...
          "Socios y ánimo de la afición, con su historia.",
        ],
      },
      {
        titulo: "Cómo leerlo",
    ...
    secciones: [
      {
        ...
        puntos: [
          ...
          "Resistencia y Forma, en su propia escala corta (de 1 a 9).",
      ...
      {
        titulo: "La línea de los 11 mejores",
        texto: [
  ...
  },
  {
    ...
    secciones: [
      ...
      {
        titulo: "La ficha de un jugador actual",
        puntos: [
      ...
      {
        titulo: "La ficha de un ex jugador",
        texto: [
  ...
  },
  {
    id: "habilidades",
    grupo: "Club",
    titulo: "Habilidades (Profundidad)",
    ruta: "/skills",
    resumen:
    ...
    secciones: [
      ...
      },
      {
        ...
        puntos: [
          ...
          "Hueco más serio: el puesto donde más pierdes.",
      ...
      {
        titulo: "Profundidad: la formación",
        texto: [
      ...
      },
      {
        ...
        puntos: [
          ...
          "No cuenta quien esté lesionado.",
  ...
  },
  {
    ...
    secciones: [
      ...
      {
        titulo: "Qué más enseña",
        puntos: [
          "Banquillo: los siguientes mejores.",
          "Ranking de formaciones: cuánto rinde cada una con tu plantilla.",
    ...
    secciones: [
      {
        ...
        puntos: [
          ...
          "Entrenador y asistentes, con su efecto sobre la velocidad.",
      ...
      {
        titulo: "Semanas hasta el próximo nivel",
        texto: [
      ...
      {
        titulo: "Cómo leer las constantes",
        puntos: [
          ...
          "Un año de Hattrick son 112 días, es decir 16 semanas.",
      ...
      {
        titulo: "Experiencia y fidelidad",
        texto: [
  ...
  },
  {
    ...
    secciones: [
      {
        titulo: "Qué se sabe de un canterano",
        texto: [
      ...
      },
      {
        ...
        puntos: [
          "Crack: techo 8 o más. Proyecto de titular.",
          "Promesa: techo 7. Merece plaza de entrenamiento.",
          "Aceptable: techo 6. Puede servir de suplente.",
          "Vendible: techo 5. Se vende sin pena.",
          "Fontanero: techo 4 o menos.",
          "Sin ojear: todavía no se ha revelado ningún techo, así que no hay veredicto.",
        ],
      },
      {
        titulo: "La asimetría que lo decide todo",
        texto: [
      ...
      {
        titulo: "Qué entrenar en la academia",
        texto: [
      ...
      {
        titulo: "El entrenamiento Individual",
        texto: [
      ...
      {
        titulo: "Ojeadores y rentabilidad",
        texto: [
  ...
  },
  {
    ...
    secciones: [
      ...
      {
        titulo: "Los sueldos de antes de HT Lens",
        texto: [
        ...
        formula: "log(sueldo) = a + b × log(TSI) + c × edad",
      },
      {
        titulo: "Tres estados, nunca dos",
        texto: [
  ...
  // ── Competición ──────────────────────────────────────────────────────────
  {
    ...
    secciones: [
      ...
      },
      {
        titulo: "Qué hay en pantalla",
        puntos: [
          "Resumen: ganados, empatados y perdidos, goles y HatStats medio.",
          ...
          "Local y visitante por separado.",
      ...
      {
        titulo: "El análisis de un partido",
        texto: [
  ...
  },
  {
    id: "pronostico",
    grupo: "Competición",
    titulo: "El pronóstico de partido",
    resumen:
    ...
    secciones: [
      ...
      {
        titulo: "1. Describir a cada equipo",
        texto: [
        ...
        puntos: [
          ...
          "Máximo: de lo que es capaz en cada zona.",
          "Máximo por carril: de lo que es capaz por cualquiera de los tres carriles.",
          "Último partido: lo del último día, sin resumir.",
      ...
      {
        titulo: "4. De los duelos a los goles",
        texto: [
        ...
        formula: "λ = (juego abierto + balón parado) × factor de la táctica",
      },
      {
        titulo: "5. La táctica",
        texto: [
    ...
    secciones: [
      {
        titulo: "Qué hay en pantalla",
        puntos: [
          "Clasificación oficial en total, en casa y fuera.",
          ...
          "Próximo partido con su pronóstico.",
      ...
      {
        titulo: "La simulación de temporada",
        texto: [
          "La respuesta a «¿en qué puesto acabo?» es una distribución. Se simula el resto de la temporada miles de veces: cada partido pendiente se juega con goles aleatorios según la fuerza de ataque y defensa de cada equipo, y se cuenta en qué puesto acaba cada uno. La fuerza se encoge hacia la media de la liga con K = 5 para no fiarse de pocos partidos, y el local tiene una ventaja de 1,20 sobre sus goles esperados.",
        ],
        formula:
          "λ local     = ataque_i × defensa_j × media de la liga × 1,20\nλ visitante = ataque_j × defensa_i × media de la liga\n\nfuerza = (goles + 5 × media) ÷ (partidos + 5)",
      },
      {
        titulo: "Cómo se resume cada equipo",
        texto: [
  ...
  },
  {
    ...
    secciones: [
      ...
      {
        titulo: "Qué hay en la ficha",
        puntos: [
          "Tu TSI frente al suyo, con histograma de las dos plantillas.",
          "Once probable y jugadores del rival identificados en sus alineaciones.",
          "Táctica habitual y formaciones que usa.",
          "Rotación del ataque: por qué lado suele cargar.",
          ...
          "Fichajes recientes y actividad del manager.",
        ],
      },
      {
        titulo: "El marcaje al hombre",
        texto: [
    ...
    secciones: [
      {
        ...
        puntos: [
          ...
          "Balances acumulados.",
          "Ingresos y gastos por semana y por temporada.",
          "Escenario de caja: la proyección, siempre aparte y marcada como escenario.",
          "Anomalías observadas: semanas que se salen de lo normal.",
        ],
      },
      {
        titulo: "La semana cerrada",
        texto: [
      ...
      {
        titulo: "Balance sin transferencias",
        texto: [
      ...
      },
      {
        ...
        puntos: [
          ...
          "La caja va peor de lo que Hattrick esperaba.",
          "La peña de aficionados está encogiendo.",
          "Un jugador se lleva una parte excesiva de la nómina.",
        ],
      },
    ],
  },
    ...
    secciones: [
      {
        ...
        puntos: [
          "Aforo total.",
          "Ocupación media sobre los partidos analizados.",
          "Ocupación de los últimos 3 partidos, cuántos se llenaron y la diferencia con la media.",
          "Partidos analizados y asientos vacíos de media.",
        ],
      },
      {
        titulo: "Ocupación por partido",
        texto: [
        ...
        formula: "ocupación = entradas vendidas ÷ aforo total × 100",
      },
      {
        titulo: "Filtros y reglas",
        puntos: [
          "Todos, oficiales o amistosos: un amistoso se llena de otra manera y mezclarlo esconde los que cuentan.",
          "Temporada, con el mismo selector que Partidos.",
          ...
          "Torneos, duelos, escaleras y preparación no cuentan nunca.",
        ],
      },
      {
        titulo: "¿Compensa ampliar?",
        texto: [
  ...
  // ── Inteligencia ─────────────────────────────────────────────────────────
  {
    ...
    ruta: "/sync",
    resumen: "El único lugar desde donde se traen datos de Hattrick.",
    secciones: [
      {
        ...
        texto: [
          ...
          "Ver también «Conectar y sincronizar» en Empezar.",
        ],
      },
    ],
  },
    ...
    secciones: [
      ...
      },
      {
        ...
        puntos: [
          ...
          "Estadio: cuándo ampliar compensaría.",
          ...
          "Datos: cuando tienen más de un día.",
        ],
      },
    ],
  },
    ...
    secciones: [
      ...
      },
      {
        ...
        puntos: [
          ...
          "Liga: simulación de temporada.",
          "Juveniles: puntaje de selección de entrenamiento.",
          "Partidos: HatStats.",
          "HTMS y HTMS28.",
          "Transferencias: ROI.",
        ],
  ...
  },
  {
    ...
    titulo: "Wiki",
    ruta: "/wiki",
    resumen: "Esta página: la documentación de todo HT Lens.",
    secciones: [
      {
        titulo: "Cómo se usa",
        texto: [
  ...
  // ── Acerca de ────────────────────────────────────────────────────────────
  {
    id: "acerca",
    grupo: "Acerca de",
    titulo: "Autor, Libro de visitas y Apoyar",
    ruta: "/autor",
    resumen:
  ...
  // ── Glosario ─────────────────────────────────────────────────────────────
  {
    id: "glosario-puestos",
    grupo: "Glosario",
    titulo: "Puestos, formaciones y órdenes",
    resumen: "Cómo se nombran los puestos y cómo se describe una formación.",
    secciones: [
      {
        titulo: "Puestos",
        texto: [
  ...
  },
  {
    ...
    grupo: "Glosario",
    titulo: "Índices",
    resumen: "TSI, HTMS, HTMS28, HatStats y rendimiento en el puesto.",
    secciones: [
      {
        titulo: "TSI",
        texto: [
  ...
  },
  {
    ...
    grupo: "Glosario",
    titulo: "El jugador",
    resumen: "Niveles, especialidades y atributos que no son habilidades.",
    secciones: [
      {
        titulo: "Niveles de habilidad",
        texto: [
      ...
      },
      {
        ...
        puntos: [
          ...
          "⚡ Rápido: velocidad.",
          "💪 Potente: fuerza; se crece con la lluvia.",
          "🎲 Imprevisible: genera eventos inesperados.",
          "🗿 Cabeceador: peligro de cabeza.",
          "🛡️ Estoico: resiste mejor las lesiones.",
          "🤝 Influyente: mejora a los compañeros de alrededor.",
        ],
      },
      {
        titulo: "Forma",
  ...
  },
  {
    ...
    grupo: "Glosario",
    titulo: "Competición y análisis",
    resumen: "Qué cuenta como oficial y otras palabras que usa la app.",
    secciones: [
      {
        titulo: "Partido oficial",
        texto: [
      ...
      {
        titulo: "Estimación, escenario y medida",
        texto: [
    ...
    <div className="space-y-4">
      <header>
        ...
        <p className="text-sm text-[var(--muted)]">
          Todo HT Lens explicado: qué responde cada pantalla, cómo se calcula,
          cómo se lee y hasta dónde vale
        </p>
      </header>
      ...
      <input
        ...
        placeholder="Buscar en la Wiki: cuello de botella, HTMS, ampliar estadio…"
      ...
      <div className="grid gap-6 lg:grid-cols-[14rem_minmax(0,1fr)]">
        ...
        <div className="space-y-6">
          {visibles.length === 0 && (
            <p className="text-sm text-[var(--muted)]">
              Nada coincide con «{busqueda}». Prueba con otra palabra.
            </p>
          )}
          {GRUPOS.map((grupo) => {
            const delGrupo = visibles.filter((a) => a.grupo === grupo);
