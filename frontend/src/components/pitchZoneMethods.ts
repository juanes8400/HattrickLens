...
export const PITCH_ZONE_METHODS: ResumenDeZonas[] = [
  ...
  // casi iguales con nombres que no se distinguen-- y el promedio la absorbe.
  {
    key: "average",
    label: "Promedio",
    short: "el promedio de los partidos vistos, zona por zona",
    long:
  ...
  },
  {
    key: "max",
    label: "Máximo",
    short: "el mejor registro en cada zona, de todos los partidos vistos",
    long:
  ...
  {
    key: "max_parallel",
    label: "Máximo por carril",
    short: "el mejor de los tres carriles paralelos, aplicado a los tres",
    long:
  ...
  },
  {
    ...
    short: "lo del último día, sin promediar nada",
    long:
...
export const NOTA_DE_LOS_RESUMENES =
